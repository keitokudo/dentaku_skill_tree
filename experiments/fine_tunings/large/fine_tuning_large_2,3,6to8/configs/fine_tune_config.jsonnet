...

{
  ...
  Logger: {
    project_name: "dentaku_skill_tree_public_seed_%s" % std.toString($.global_setting.seed),
  ...
  pl_module_setting: {
    ...
    model_name_or_path: "%s/experiment_results/pretrain_%s_2,3,6to7,8_seed_%s/weights/%s" % [
      ROOT_DIR,
      model_size,
